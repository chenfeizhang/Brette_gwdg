...
#with open("/scratch/chenfei/Brette/Output/%d" % i, "w") as f:
#  f.write("test")
...
np.save(foldername + '/Series' + str(i) + '/STA', {'STA':STA}, allow_pickle=True)
np.save(foldername + '/Series' + str(i) + '/spiketimelist', {'spiketimelist':spiketimelist}, allow_pickle=True)
